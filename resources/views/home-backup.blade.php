...
<div class="min-h-screen flex flex-col">
    <section class="relative bg-gradient-hero py-24 md:py-40 overflow-hidden">
        @if(!empty($heroSettings->hero_image_url))
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-4xl mx-auto text-center animate-fade-in">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-8">
                    <span class="w-2 h-2 rounded-full bg-accent animate-pulse"></span>
                    <span class="text-sm font-medium text-accent">{{ __('ui.digital_memorials') }}</span>
                </div>

                <h1 class="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 text-primary leading-tight">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a
                        ...
                        class="inline-flex items-center justify-center px-8 h-12 text-base border-2 border-primary rounded-lg font-semibold hover:bg-primary/5 transition-colors"
                    >
                        {{ __('ui.home.cta_more') }}
                    </a>
                </div>
        ...
        @if(empty($heroSettings->hero_image_url))
            <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-10"></div>
        @endif
    </section>
